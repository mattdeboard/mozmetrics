...
const EXPORTED_SYMBOLS = ["ExperimentDataStore", "TYPE_INT_32", "TYPE_DOUBLE",
                          "TYPE_STRING"];
...
Cu.import("resource://modules/dbutils.js");
Cu.import("resource://lib/log4moz.js");
Cu.import("resource://lib/string_sanitizer.js");
...
ExperimentDataStore.prototype = {
  _init: function EDS__init(fileName, tableName, columns) {
    ...
    let logger = Log4Moz.repository.getLogger("MozMetrics.Database");
  ...
  storeEvent: function EDS_storeEvent(uiEvent, callback) {
    ...
    for (i = 0; i < this._columns.length; i++) {
      ...
      switch (this._columns[i].type) {
        case TYPE_INT_32:
        case TYPE_DOUBLE:
          insStmt.bindByIndex(i, datum);
        break;
        case TYPE_STRING:
          insStmt.bindByIndex(i, sanitizeString(datum));
        break;
      }
    }
