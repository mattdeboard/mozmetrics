...
exports.dataStoreInfo = {
    ...
    fileName: "daily_browser_usage_sums.sqlite",
    tableName: "daily_usage_patterns",
    columns: [{property: "timestamp", 
	      ...
	      {property: "ev1_sum", 
               type: BaseClasses.TYPE_INT_32, displayName: "Event Code 1 Sum",
...
/*DailyUseStudyWebContent.prototype.deleteDataOlderThanADay = function(store) {
  ...
  if (selectStmt.executeStep()) {
    ...
    let cutoffDate = timestamp - (24 * 60 * 60 * 1000);
